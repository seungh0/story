...
class FeedMappingCreateApiRequestTest : StringSpec({
    ...
    "피드 매핑에 대한 설명이 비어있을 수 있다" {
        // given
        val request = FeedMappingCreateApiRequest(description = "", retention = Duration.ofDays(30))
    ...
    "피드 매핑에 대한 설명은 최대 300자까지만 사용할 수 있다" {
        // given
        val request = FeedMappingCreateApiRequest(description = "1".repeat(n = 300), retention = Duration.ofDays(30))
    ...
    "피드 매핑에 대한 설명은 301자 이상인 경우 사용할 수 없다" {
        // given
        val request = FeedMappingCreateApiRequest(description = "1".repeat(n = 301), retention = Duration.ofDays(30))
