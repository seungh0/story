...
| 400 | invalid_cursor | 유효하지 않은 커서가 요청된 경우
| 400 | invalid_post_id | 유효하지 않은 포스트 ID가 요청된 경우
| 400 | inactivated_workspace | 비활성화된 워크스페이스인 경우
| 400 | invalid_nonce | 유효하지 않은 Nonce인 경우
| 400 | invalid_post_sort_by | 유효하지 않은 포스트 정렬 방식인 경우
...
| 409 | already_connected_feed_mapping | 피드 매핑 중복 시 발생
