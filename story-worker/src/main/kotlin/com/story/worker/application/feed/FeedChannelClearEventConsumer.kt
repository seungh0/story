...
@EventConsumer
class FeedChannelClearEventConsumer(
    @IOBound
    private val dispatcher: CoroutineDispatcher,

    private val feedChannelClearHandler: FeedChannelClearHandler,
) {
            ...
            chunkedRecords.map { record ->
                withContext(dispatcher) {
                    launch {
                        ...
                        feedChannelClearHandler.clearAllFeedByChannelId(
                            workspaceId = payload.workspaceId,
                            ownerId = payload.subscriberId,
