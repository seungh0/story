...
object ProcessUtils {
    ...
    private fun executeGrepProcessCommand(port: Int): Process {
        if (isWindows) {
            throw com.story.platform.core.common.error.InternalServerException("프로세스 실행 여부 확인은 Windows OS는 지원하지 않습니다")
        }
