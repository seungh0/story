...
class FeedMappingCreatorTest(
    ...
    "FeedMapping을 추가합니다" {
        ...
        // then
        val feedMappings = feedMappingRepository.findAll().toList()
        ...
        val feedMappingReverses = feedMappingReverseRepository.findAll().toList()
    ...
    "이미 설정된 피드 매핑인 경우 등록할 수 없다" {
        ...
        feedMappingRepository.save(feedMapping)
    ...
    "Source - Subscription 관계간 최대 3개까지만 피드 매핑을 설정할 수 있다" {
        ...
        feedMappingRepository.saveAll(feedMappings).toList()
