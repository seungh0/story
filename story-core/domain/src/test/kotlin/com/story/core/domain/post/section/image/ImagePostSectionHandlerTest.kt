...
class ImagePostSectionHandlerTest : StringSpec({
    ...
    "ImagePostSectionContentCommand -> ImagePostSectionContent" {
        // given
        val section1 = ImagePostSectionContentCommand(
            priority = 1,
            fileId = 1L,
            extra = mapOf(
                "extra" to 10
        ...
        val section2 = ImagePostSectionContentCommand(
            priority = 2,
            fileId = 2L,
            extra = emptyMap(),
        )

        coEvery { fileReader.getFiles(any(), any(), any()) } returns mapOf(
            1L to File(
