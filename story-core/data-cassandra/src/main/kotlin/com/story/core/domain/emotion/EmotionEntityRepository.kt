...
class EmotionEntityRepository(
    ...
    override suspend fun findAllByKeyWorkspaceIdAndKeyResourceIdAndKeyComponentId(
        ...
        return entities.map { entity -> entity.toEmotion() }
    }
    ...
    override suspend fun delete(workspaceId: String, resourceId: ResourceId, componentId: String, emotionId: String) {
        emotionCassandraRepository.deleteById(
            EmotionPrimaryKey(
                workspaceId = workspaceId,
                resourceId = resourceId,
                componentId = componentId,
